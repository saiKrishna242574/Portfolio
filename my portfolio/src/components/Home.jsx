    ...
    <div>
      ...
      <div className='flex bg-gradient-to-r from-teal-900 to-black flex-col md:flex-row items-center justify-center h-screen'>
        <div className='w-full ml-[4vw] md:w-2/4 px-[4vw] py-[6vw] text-center md:text-left'>
          ...
          <h3 className='text-4xl font-serif'>And I am a <FlipWords words={words} duration={3000} className="text-teal-400" /></h3>
          <p className='text-xl text-white mt-[2vw] '>
        ...
        <div className='flex ml-[10vw] justify-center items-center'>
          <div>
            <img 
              className='rounded-full w-3/4 hover:shadow-2xl hover:shadow-teal-500 transition-shadow duration-500' 
